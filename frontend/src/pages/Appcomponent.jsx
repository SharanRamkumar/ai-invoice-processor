...
function App() {
  ...
  async function handleUpload() {
    ...
    try {
      ...
      // DUPLICATE CHECK
      if (
        body?.["This is a duplicate data"]?.output?.toLowerCase() ===
        "duplicate"
      ) {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-4xl mx-auto mt-12 mb-10 px-6">
        ...
        <p className="text-center text-gray-600 max-w-2xl mx-auto mb-8">
          ...
          information quickly and provides an intelligent assistant for
          invoice, GST, payment, and finance-related questions.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">
              Upload an invoice and automatically extract important details
              such as vendor name, invoice number, invoice dates, tax amount,
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            ...
            <p className="text-gray-600">
              The AI assistant can retrieve relevant information from your
              stored invoice and finance policies before generating an answer.
            </p>
          </div>
      ...
      <div className="max-w-xl mx-auto mt-10 px-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md mb-6 border border-blue-100">
          ...
          <p className="text-gray-600 mb-4">
            For the best extraction results, please make sure your invoice
          ...
          <ul className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start gap-2">
              <span>✅</span>
              <span>
                Supported formats should be PDF or common image formats such as
                JPG and PNG.
              </span>
            </li>
            ...
            <li className="flex items-start gap-2">
              <span>✅</span>
              <span>
                Make sure important invoice information is clearly visible.
              </span>
            </li>
            ...
            <li className="flex items-start gap-2">
              <span>⚠️</span>
              <span>
                Avoid blurry, cropped, or heavily distorted invoice documents.
              </span>
            </li>
          </ul>
        </div>
